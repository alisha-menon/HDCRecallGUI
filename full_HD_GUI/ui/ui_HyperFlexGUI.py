...
class Ui_HyperFlexGUI(object):
    ...
    def retranslateUi(self, HyperFlexGUI):
        ...
        self.gestureSetsLabel.setText(_translate("Experiment", "Gesture Set:", None))
