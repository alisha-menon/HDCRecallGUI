...
function [prog_HV, result_AM] = hdcrorbtrain (few_all, length_training, features_condition, features_result, chAMcondition, chAMresult, iMchcondition, iMchresult, D, precision_condition, precision_result, channels_condition, channels_result)
%
