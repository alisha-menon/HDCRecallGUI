...
function [prog_HV, prog_HVlist, result_AM, known_condition_integers, result_integers_list] = hdcrorbtrain (length_training, features_condition, features_result, chAMcondition, chAMresult, iMchcondition, iMchresult, D, precision_condition, precision_result, channels_condition, channels_result)
%
